...
class Timer:
    ...
    def __init__(self, logger:Logger, verbosity_level=1, log_fn=None, skip_first=True, on_cuda=False):
    ...
    def _default_log_fn(self, _, values, tags):
        ...
        self.logger.info(f"Timer: {label} @ {epoch:4.1f} - {duration:8.5f}s")